export { default as DiscoverySearch, SearchApi, SearchContext } from './components/DiscoverySearch/DiscoverySearch';
...
export { HtmlView, canRenderHtmlView } from './components/DocumentPreview/components/HtmlView/HtmlView';
